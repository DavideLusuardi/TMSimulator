...
set yrange [-1:1.5]
#set key font ",14"
plot "aw_without_control.txt" using 1:2 with lines linewidth 2 linecolor rgb "red" title "senza controllore", \
     "aw_with_control.txt" using 1:2 with lines linewidth 2 linecolor rgb "black" title "con controllore"
