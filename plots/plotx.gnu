...
set yrange [-30:40]
#set key font ",14"
plot "x_without_control.txt" using 1:2 with lines linewidth 2 linecolor rgb "red" title "senza controllore", \
     "x_with_control.txt" using 1:2 with lines linewidth 2 linecolor rgb "black" title "con controllore"
